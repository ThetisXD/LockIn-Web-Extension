...
<ul align="left">
  ...
  <li>The tab blacklist is an optional feature that users can enable. When active, the web browser periodically scans the browser and matches the web browser URL to it, blocking it from the browser.</li>
</ul>
