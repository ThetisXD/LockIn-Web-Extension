...
//a function that disabled the button based on active state of clock run time.
...
//take total_second derived user current time, display the user next goal timepost.
...
/**transition state, synchronize all toggle based on the stored booleans state. */
...
// =================================================================================================
// POMODORO SCHEDULE DISPLAYS AND FORMATTING
// =================================================================================================
